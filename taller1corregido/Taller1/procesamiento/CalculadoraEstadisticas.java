...
public class CalculadoraEstadisticas
{
	...
	public String darNombrePaisDeAtleta(String nombre)
	{
		Atleta infoAtleta = buscarAtleta(nombre);
		if ( infoAtleta == null)
			return null;
		else
		{
			Pais infoPais = infoAtleta.darPais();
			String nombrePais = infoPais.darNombre();
