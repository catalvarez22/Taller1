...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("12. Consultar el pais de un atleta");
	 ...
	 *             aplicación
	 */
	public void ejecturaPaisNombreAtleta()
	{
		System.out.println("Pais de un atleta");
		String nombre = input("Ingrese el nombre de un atleta");
		String nombrePais = calculadora.darPais(nombre);
		if (nombrePais == null)
		System.out.println("No se encuentra este atleta");
		else
		{
			System.out.println("EL pais de" + nombre + "es " + nombrePais);
		}
	}
